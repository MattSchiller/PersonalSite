...
/***/ function(module, exports) {
	...
	var About = {
	    stub: "~Cindent0~" + "~ccomment~<!DOCTYPE html>" + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent0~" + "~ccomment~<!--Hi, I'm Matt Schiller, a Web Developer and freelance Technical Consultant." + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent0~" + "~ccomment~(I build out enterprise software capabilities and construct cool things on the internet for money and fun.)" + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent0~" + "~ccomment~My work experience grows from a SQL & Excel/VBA background. For years I've implemented SaaS for Pharmaceutical, Healthcare, and Higher Education systems (like " + "~ccomment~Johnson & Johnson" + "~ahttp://www.janssen.com/~" + "~ccomment~" + " and " + "~ccomment~Gonzaga University" + "~ahttp://www.gonzaga.org~" + "~ccomment~), often having to learn new languages and database structures in the process. Which is 100% my jam." + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent0~" + "~ccomment~I thrive in using the right tool for a job, whether it's in my toolbelt yet or not. Sometimes that means the React framework in JavaScript to put together the dynamic website you see before you. Sometimes it means working in Python to build out a game's AI or handle the back end." + "~l0~" + "~Cindent0~" + "~l0~",

	    writing: "~Cindent0~" + "~ccomment~And a good day's work is great, going to bed at night feeling like you've really SPENT the day well is one of my favorite things, but there's more to life than a good work ethic. I believe in building fun and and interesting things all time, separate from technology. For instance, I'm an avid folder of origami, something not many people are too well-versed in." + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent0~" + "~ccomment~So welcome to my site, my corner of this digital world. Take your time and explore, and let me know if any of my work has piqued your interest.-->" + "~l0~" + "~Cindent0~" + "~l0~" + "~Cindent1=0~" + "<" + "~ckey~html" + "~c0~>" + "~l0~" + "~p350~" + "~Cindent1~" + "<" + "~ckey~body" + "~c0~>" + "~l0~" + "~p350~" + "~Cindent2~" + "Thanks for checking out my site! Mchu" + "~b3~" + "uch of it is still under construcktoi" + "~p300~" + "~b4~" + "tion." + "~l0~" + "~Cindent1~" + "</" + "~ckey~body" + "~c0~>" + "~l0~" + "~Cindent0~" + "</" + "~ckey~html" + "~c0~>" + "~l0~"
	};
...
/***/ function(module, exports) {
	...
	var Hobbies = {
	      ...
	      writing: "~Cindent0~" + ".hobbies" + "~CfuncName~" + " {" + "~l0~" + "~Cindent1~" + "origami" + "~Cfunc~" + "~cspace~:     " + "~c0~" + "24 years" + "~ahttps://goo.gl/photos/dxTN5bMiAVqE5gA89~" + "~c0~" + ";" + "~l0~" + "~Cindent1~" + "travel-blog" + "~Cfunc~" + ": " + "~c0~" + "www.MostlyNonFiction.com" + "~ahttp://www.mostlynonfiction.com~" + "~c0~" + ";" + "~l0~" + "~Cindent1~" + "costumes" + "~Cfunc~" + "~cspace~:    " + "~c0~" + "super-cool" + "~ahttps://goo.gl/photos/YKGpuzTFbfbqWzKz6~" + "~c0~" + ";" + "~l0~" + "~Cindent0~" + "}"
	};
...
/***/ function(module, exports) {
	...
	var Contact = {
	    ...
	    writing: "~Cindent2~" + '"linkedIn": "' + "~c0~" + 'www.linkedIn.com/in/MattSSchiller' + "~ahttps://www.linkedIn.com/in/MattSSchiller~" + '~c0~",' + "~l0~" + "~Cindent2~" + '"gitHub":' + '~cspace~   "' + "~c0~" + 'www.gitHub.com/MattSchiller' + "~ahttps://www.gitHub.com/MattSchiller~" + '~c0~"' + "~l0~" + "~Cindent1~" + "}" + "~l0~" + "~Cindent0~" + "}"
	};
