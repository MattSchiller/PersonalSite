...
export const simTypeContainerTypescriptTheme: string;
export const defaultColor: string;
export const simTypeContainerHtmlTheme: string;
export const simTypeContainerYamlTheme: string;
...
export const tabsCapoLight: string;
