...
export default {
    ...
    simTypes: [{
        simTypeId: "About_1",
        sourceText: "~Cindent0~" + "~ccomment~<!DOCTYPE html>" + "~l0~",
        sourceText_:
            ...
            "~l0~" +
            "~Cindent0~" + "~l0~" +
            "~Cindent0~" + "~ccomment~I thrive in using the right tool for a job, whether it's in my toolbelt yet or not. " +
            "Sometimes that means the React framework in JavaScript to put together the dynamic website you see before you. " +
            "Sometimes it means working in Python to build out a game's AI or handle the back end." + "~l0~" +
            "~Cindent0~" + "~l0~" +
            "~s~" +
