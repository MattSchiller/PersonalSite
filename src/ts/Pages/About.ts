var About = {
    stub: "~Cindent0~" + "~ccomment~<!DOCTYPE html>" + "~l0~"
        ...
        + "~Cindent0~" + "~l0~"
        + "~Cindent0~" + "~ccomment~(I build out enterprise software capabilities and construct cool things on the internet for money and fun.)" + "~l0~"
        + "~Cindent0~" + "~l0~"
        + "~Cindent0~" + "~ccomment~My work experience grows from a SQL & Excel/VBA background. For years I've implemented SaaS for Pharmaceutical, Healthcare, and Higher Education systems (like " + "~ccomment~Johnson & Johnson" + "~ahttp://www.janssen.com/~"
